...
public class Matriz {
    ...
    public static Matriz matrizInversaSSV(Matriz a) throws DimensionesIncompatibles {
if(! a.getDimension().height.equals(a.getDimension().width)) throw new DimensionesIncompatibles("La matriz debe ser cuadrada");
double det=1/determinanteSSV(a);
Matriz nmatriz=matrizAdjuntaSSV(a);
multiplicarMatrizSSV(det,nmatriz);
return nmatriz;
}


public static Matriz matrizAdjuntaSSV(Matriz a){
return matrizTranspuestaSSV(matrizCofactoresSSV(a));
}

public Matriz matrizCofactoresSSV(Matriz a){
...
public Matriz matrizTranspuestaSSV(Matriz a){
int i, j, dimensionA;
dimensionA=a.getDimension().height;
...
public double determinanteSSV(Matriz a){
...
Matriz nm = new Matriz(dimensionA-1, dimensionA-1, false);
    ...
    if(i%2==0)
        suma+=a.datos[i][0] * determinanteSSV(nm);
    else
        suma-=a.datos[i][0] * determinanteSSV(nm);
}
return suma;
